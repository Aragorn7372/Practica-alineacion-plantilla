package org.example.newteamultimateedition.common.config
 ...
 * @property configProperties Propiedades de la configuración
 */
object Config {
    private val logger = logging()
    val configProperties: ConfigProperties = loadConfig()
    ...
    private fun loadConfig(): ConfigProperties {
        ...
        val databaseInitData = propiedades.getProperty("database.init.data").toBoolean()
