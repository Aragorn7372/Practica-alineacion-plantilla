...
class EquipoStorageJSON: EquipoStorage {
    ...
    override fun fileRead(file: File): Result<List<Integrante>, GestionErrors> {
        ...
        val listaIntegrantes = listaIntegrantesDTO.map { org.example.newteamultimateedition.personal.mapper.toModel() } // Mapeamos la lista de DTO para convertir cada elemento a un modelo segun convenga
